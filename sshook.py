...
def main():
    try:
        while True:
          ...
          {Fore.YELLOW}[{Fore.WHITE}1{Fore.YELLOW}]{Fore.WHITE} Spammer                   {Fore.YELLOW}[{Fore.WHITE}7{Fore.YELLOW}]{Fore.WHITE} Embed Maker
          
          {Fore.YELLOW}[{Fore.WHITE}2{Fore.YELLOW}]{Fore.WHITE} Remover                   {Fore.YELLOW}[{Fore.WHITE}8{Fore.YELLOW}]{Fore.WHITE} Poll Creator
                                                                                          
          {Fore.YELLOW}[{Fore.WHITE}3{Fore.YELLOW}]{Fore.WHITE} Check Validity            {Fore.YELLOW}[{Fore.WHITE}9{Fore.YELLOW}]{Fore.WHITE} Exit
          ...
          {Fore.YELLOW}[{Fore.WHITE}6{Fore.YELLOW}]{Fore.WHITE} Name Changer
    """) 
...
def create_embed():
    ...
    try:
        ...
        print(f"{Fore.YELLOW}[{Fore.LIGHTRED_EX}!{Fore.YELLOW}]{Fore.WHITE} Invalid color format. Using default green.")
        color = 0x00FF00
    embed.color = color
...
def create_poll_menu():
    ...
    print_logo()
    print(f"{Fore.YELLOW}[{Fore.WHITE}+{Fore.YELLOW}]{Fore.WHITE} Enter the WebHook URL to send the simple poll message ")
    webhook_url = input(f"""{Fore.YELLOW}[{Fore.RED}#{Fore.YELLOW}]{Fore.WHITE} WebHook URL: """)
